...
function esPrimo(num) {
   ...
   // Tu código:
      ...
      if(num <= 1) {
        return false; // Los números negativos, 0 y 1 NO son números primos.
      }
      for(var i = 2; i < num; i++) {
        if(num % i === 0) {
          return false; // Si el número es divisible por otro número distinto de 1 y de sí mismo, entonces no es primo.
        }
      }
      return true; // Si el número no es divisible por ningún número distinto de 1 y de sí mismo, entonces es primo.
